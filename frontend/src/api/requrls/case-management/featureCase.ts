...
// 获取用例详情弹窗关联用例接口用例
export const GetApiCasePageUrl = '/functional/case/test/associate/case/page';
// 获取接口测试接口模块数量
export const GetApiCaseModuleCountUrl = '/functional/case/test/associate/case/module/count';
// 获取用例详情接口模块树
export const GetCaseApiModuleTreeUrl = '/case/definition/module/tree';
// 获取前后置用例列表
