<template>
  <el-dropdown @command="handleCommand" class="scenario-ext-btn">
    ...
    <el-dropdown-menu slot="dropdown">
      ...
      <el-dropdown-item :disabled="isCaseEdit" command="create_performance" v-permission="['PROJECT_API_DEFINITION:READ+CREATE_PERFORMANCE']">{{ $t('api_test.create_performance_test') }}</el-dropdown-item>
    </el-dropdown-menu>
