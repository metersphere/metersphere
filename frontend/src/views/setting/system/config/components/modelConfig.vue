<template>
  <div>
    <MsCard :loading="loading" simple :special-height="119" no-content-padding>
      <MsSplitBox>
        <template #first>
          <div class="model-list-wrapper">
            ...
            <div>
              <div
                ...
                @click="changeModelType(item.value)"
              >
        ...
        <template #second>
                  ...
                  <template #item="{ item }">
                    <div class="rounded-md bg-[var(--color-text-fff)] p-[24px]">
                      ...
                      <div class="model-item-footer mt-[24px] flex items-center justify-between">
                        ...
                        <a-switch v-model="item.enable" size="small" @change="(v) => changeStatus(v, item.key)" />
                      </div>
                    </div>
                  </template>
                </MsCardList>
          ...
          <ModelEditDrawer
            ...
            :supplier-model-type="activeModelType"
            @close="handleCancel"
          />
        </template>
      </MsSplitBox>
...
<script setup lang="ts">
  ...
  function changeModelType(key: ModelBaseTypeEnum) {
  ...
  function changeStatus(value: string | number | boolean, key: string | undefined) {}
