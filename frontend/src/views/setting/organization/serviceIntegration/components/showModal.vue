<template>
  ...
  >
    ...
    <div style="width: 100%">
      <!-- <form-create v-model:api="fApi" :rule="formRules" :option="options" /> -->
      <MsFormCreate v-model:api="fApi" :rule="formRules" :option="options" @address-blur="changeaddress"></MsFormCreate>
    </div>
...
<script setup lang="ts">
  ...
  import type { FormRule } from '@form-create/arco-design';

  import MsFormCreate from '@/components/pure/ms-form-create/index.vue';
