      ...
      apiInfo: {
        ...
        request: {
          body: {
            ...
            wwwFormBody: {
              formValues: mock.mockMatchRule.body.wwwFormBody.matchRules.map((e) => ({
                ...defaultBodyParamsItem,
                key: e.key,
                value: e.value,
              })),
            ...
            formDataBody: {
              formValues: mock.mockMatchRule.body.formDataBody.matchRules.map((e) => ({
                ...defaultBodyParamsItem,
                key: e.key,
                value: e.value,
                files: e.files || [],
          ...
          headers: mock.mockMatchRule.header.matchRules.map((e) => ({
            ...defaultHeaderParamsItem,
            key: e.key,
            value: e.value,
          })),
          query: mock.mockMatchRule.query.matchRules.map((e) => ({
            ...defaultRequestParamsItem,
            key: e.key,
            value: e.value,
          })),
          rest: mock.mockMatchRule.rest.matchRules.map((e) => ({
            ...defaultRequestParamsItem,
            key: e.key,
            value: e.value,
          })),
