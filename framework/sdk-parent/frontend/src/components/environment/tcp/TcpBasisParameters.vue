            ...
            <el-tabs v-model="activeName" class="request-tabs">
              ...
              <el-tab-pane :label="$t('api_test.definition.request.message_template')" name="request">
                <div class="send-request">
                  <ms-code-edit v-if="activeName === 'request'" mode="text" :read-only="isReadOnly"
                                :data.sync="request.request" :modes="['text', 'json', 'xml', 'html']" theme="eclipse"/>
                </div>
              </el-tab-pane>
...
export default {
  ...
  components: {
    ...
    MsCodeEdit,
    MsApiKeyValue, ApiEnvironmentConfig
  },
  props: {
    request: {},
    basisData: {},
  ...
  created() {
    ...
    if (!this.request.tcpPreProcessor) {
      this.$set(this.request, 'tcpPreProcessor', {})
    }
    if (this.request.tcpPreProcessor) {
