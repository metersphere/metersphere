    ...
    <el-tabs v-model="activeName" class="request-tabs">
      ...
      <el-tab-pane :label="$t('api_test.definition.request.all_pre_script')" name="allPreScript" v-if="showPre">
        ...
        <div v-if="(request.script.globalScriptConfigRaw1 || request.script.globalScriptConfigRaw2)">
          <div v-if="request.script.globalScriptConfig">
            <div
              v-if="request.script.globalScriptConfig.filterRequestPreScriptRaw1 || request.script.globalScriptConfig.filterRequestPreScriptRaw2">
              <el-radio-group size="mini">
                <el-radio-button :label="$t('api_test.script.pre_script_filter_request_type')"/>
              </el-radio-group>
              <div
                v-html="getDiff(request.script.globalScriptConfig.filterRequestPreScriptRaw2, request.script.globalScriptConfig.filterRequestPreScriptRaw1)"></div>
            </div>
            <div
              v-if="request.script.globalScriptConfig.isPreScriptExecAfterPrivateScriptRaw1 || request.script.globalScriptConfig.isPreScriptExecAfterPrivateScriptRaw2">
              <el-radio-group size="mini">
                <el-radio-button :label="$t('api_test.script.pre_script_exec_order')"/>
              </el-radio-group>
              <div
                v-html="getDiff(request.script.globalScriptConfig.isPreScriptExecAfterPrivateScriptRaw2, request.script.globalScriptConfig.isPreScriptExecAfterPrivateScriptRaw1)"></div>
            </div>
            <div
              v-if="request.script.globalScriptConfig.connScenarioPreScriptRaw1 || request.script.globalScriptConfig.connScenarioPreScriptRaw2">
              <el-radio-group size="mini">
                <el-radio-button :label="$t('api_test.script.pre_link_scenario_result')"/>
              </el-radio-group>
              <div
                v-html="getDiff(request.script.globalScriptConfig.connScenarioPreScriptRaw2, request.script.globalScriptConfig.connScenarioPreScriptRaw1)"></div>
            </div>
          </div>
        </div>
      ...
      <el-tab-pane :label="$t('api_test.definition.request.all_post_script')" name="allPostScript" v-if="showPost">
        ...
        <div v-if="(request.script.globalScriptConfigRaw1 || request.script.globalScriptConfigRaw2)">
          <div v-if="request.script.globalScriptConfig">
            <div
              v-if="request.script.globalScriptConfig.filterRequestPostScriptRaw1 || request.script.globalScriptConfig.filterRequestPostScriptRaw2">
              <el-radio-group size="mini">
                <el-radio-button :label="$t('api_test.script.post_script_filter_request_type')"/>
              </el-radio-group>
              <div
                v-html="getDiff(request.script.globalScriptConfig.filterRequestPostScriptRaw2, request.script.globalScriptConfig.filterRequestPostScriptRaw1)"></div>
            </div>
            <div
              v-if="request.script.globalScriptConfig.isPostScriptExecAfterPrivateScriptRaw1 || request.script.globalScriptConfig.isPostScriptExecAfterPrivateScriptRaw2">
              <el-radio-group size="mini">
                <el-radio-button :label="$t('api_test.script.post_script_exec_order')"/>
              </el-radio-group>
              <div
                v-html="getDiff(request.script.globalScriptConfig.isPostScriptExecAfterPrivateScriptRaw2, request.script.globalScriptConfig.isPostScriptExecAfterPrivateScriptRaw1)"></div>
            </div>
            <div
              v-if="request.script.globalScriptConfig.connScenarioPostScriptRaw1 || request.script.globalScriptConfig.connScenarioPostScriptRaw2">
              <el-radio-group size="mini">
                <el-radio-button :label="$t('api_test.script.post_link_scenario_result')"/>
              </el-radio-group>
              <div
                v-html="getDiff(request.script.globalScriptConfig.connScenarioPostScriptRaw2, request.script.globalScriptConfig.connScenarioPostScriptRaw1)"></div>
            </div>
          </div>
        </div>
