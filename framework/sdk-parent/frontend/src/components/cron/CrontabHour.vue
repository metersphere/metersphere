  ...
  <el-form size="small">
    ...
    <el-form-item>
      <el-radio v-model='radioValue' :label="2">
        ...
        -
        <el-input-number v-model='cycle02' :min="0" :max="23"/>
        小时
      </el-radio>
    </el-form-item>
    ...
    <el-form-item>
      <el-radio v-model='radioValue' :label="3">
        ...
        <el-input-number v-model='average01' :min="0" :max="23"/>
        {{ $t('schedule.cron.hours') }}{{ $t('schedule.cron.start') }}，{{ $t('schedule.cron.every') }}
        <el-input-number v-model='average02' :min="1" :max="23"/>
        {{ $t('schedule.cron.hours') }}{{ $t('schedule.cron.execute_once') }}
      </el-radio>
    </el-form-item>
