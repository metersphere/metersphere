...
public class JSONSchemaRunTest {
    ...
    private static void generator(String json, Map obj, Map<String, String> map) {
        analyzeSchema(json, obj, map);
    }

    private static void analyzeSchema(String json, Map rootObj, Map<String, String> map) {
        Gson gson = new Gson();
    ...
    private static void analyzeRootSchemaElement(JsonObject rootElement, Map rootObj, Map<String, String> map) {
    ...
    private static void analyzeObject(JsonObject object, Map rootObj, Map<String, String> map) {
    ...
    private static void valueOf(String evlValue, String propertyName, Map concept) {
    ...
    private static void analyzeProperty(Map concept, String propertyName,
            ...
            for (int i = 0; i < jsonArray.size(); i++) {
                ...
                if (object.has("items")) {
                    if (isMock(itemsObject)) {
                        ...
                        Map propertyConcept = new HashMap();
