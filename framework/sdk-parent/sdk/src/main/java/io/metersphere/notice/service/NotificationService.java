...
import io.metersphere.base.mapper.ext.BaseNotificationMapper;
...
public class NotificationService {
    ...
    public Notification getNotification(int id) {
        return baseNotificationMapper.getNotification(id, SessionUtils.getUser().getId());
    }
    ...
    public List<Notification> listNotification(Notification notification) {
        ...
        return baseNotificationMapper.listNotification(notification);
    }
    ...
    public List<Notification> listReadNotification(Notification notification) {
        ...
        return baseNotificationMapper.listReadNotification(search, SessionUtils.getUser().getId());
    }
    ...
    public List<Notification> listUnreadNotification(Notification notification) {
        ...
        return baseNotificationMapper.listUnreadNotification(search, SessionUtils.getUser().getId());
    }
