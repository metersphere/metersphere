      ...
      <el-main class="container">
        <el-scrollbar>
          ...
          <el-form ref="form" :model="form" :rules="rules" label-position="right" label-width="80px" size="small">
            <el-form-item :label="$t('custom_template.template_name')" :label-width="labelWidth" prop="name">
            ...
            <el-form-item :label="$t('custom_template.base_fields')" :label-width="labelWidth" class="filed-list">
            </el-form-item>
            <el-form-item>
              <el-row>
                <el-col :span="6">
            ...
            <el-form-item :label="$t('custom_template.selected_custom_fields')" :label-width="labelWidth" class="filed-list">
