...
import {getFieldTemplateCaseOption, getFieldTemplateIssueOption, getFieldTemplateApiOption} from "../../../api/template";
...
export default {
  ...
  methods: {
    getTemplateOptions() {
      ...
      if (this.scene === 'ISSUE') {
        promise = getFieldTemplateIssueOption(projectId)
      } else if (this.scene === 'API') {
        promise = getFieldTemplateApiOption(projectId)
      } else {
        promise = getFieldTemplateCaseOption(projectId);
      }
