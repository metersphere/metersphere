...
public class ProjectApplicationService {
    ...
    private void doBeforeUpdate(ProjectApplication projectApplication) {
        ...
        if (StringUtils.equals(type, ProjectApplicationType.CASE_CUSTOM_NUM.name())
            ...
            this.doHandleTestCaseCustomNum(projectId);
    ...
    public void closeMockTcp(Project project) {
        if (project == null) {
            ...
            ProjectConfig config = this.getSpecificTypeValue(project.getId(), ProjectApplicationType.MOCK_TCP_PORT.name());
    ...
    private void openMockTcp(Project project) {
        if (project == null) {
            MSException.throwException("Project not found!");
        } else {
            ProjectConfig config = this.getSpecificTypeValue(project.getId(), ProjectApplicationType.MOCK_TCP_PORT.name());
