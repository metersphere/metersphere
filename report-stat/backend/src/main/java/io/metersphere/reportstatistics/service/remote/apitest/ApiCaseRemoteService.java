...
public class ApiCaseRemoteService extends ApiTestBaseService {
    private static final String URL_COUNT_API_CASE_BY_REQUEST = "/api/testcase/count";
    ...
    public List<TestCaseCountChartResult> countTestCaseByRequest(TestCaseCountRequest request) {
        ...
        try {
            returnList = microService.postForDataArray(serviceName, URL_COUNT_API_CASE_BY_REQUEST, request,
