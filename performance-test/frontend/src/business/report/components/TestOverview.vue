  ...
  methods: {
    initTableData() {
      if (this.planReportTemplate) {
        ...
        getSharePerformanceReportOverview(this.shareId, this.id)
          .then(({data}) => {
            this.buildInfo(data);
          });
      } else {
        getPerformanceReportOverview(this.id)
          .then(({data}) => {
            this.buildInfo(data);
          });
      }
    ...
    getLoadChart() {
      if (this.planReportTemplate) {
        ...
        getSharePerformanceReportLoadChart(this.shareId, this.id)
          .then(({data}) => {
            this.handleGetLoadChart(data);
          });
      } else {
        getPerformanceReportLoadChart(this.id)
          .then(({data}) => {
            this.handleGetLoadChart(data);
          });
      }
    ...
    getResChart() {
      if (this.planReportTemplate) {
        ...
        getSharePerformanceReportResChart(this.shareId, this.id)
          .then(({data}) => {
            this.handleGetResChart(data);
          });
      } else {
        getPerformanceReportResChart(this.id)
          .then(({data}) => {
            this.handleGetResChart(data);
          });
      }
    ...
    getErrorChart() {
      if (this.planReportTemplate) {
        ...
        getSharePerformanceReportErrorChart(this.shareId, this.id)
          .then(({data}) => {
            this.handleGetErrorChart(data);
          });
      } else {
        getPerformanceReportErrorChart(this.id)
          .then(({data}) => {
            this.handleGetErrorChart(data);
          });
      }
    ...
    getResponseCodeChart() {
      if (this.planReportTemplate) {
        ...
        getSharePerformanceReportResponseCodeChart(this.shareId, this.id)
          .then(({data}) => {
            this.handleGetResponseCodeChart(data);
          });
      } else {
        getPerformanceReportResponseCodeChart(this.id)
          .then(({data}) => {
            this.handleGetResponseCodeChart(data);
          });
      }
