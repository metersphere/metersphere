  ...
  methods: {
    initTableData() {
      if (this.planReportTemplate) {
        ...
        getSharePerformanceReportErrorsContent(this.shareId, this.id)
          .then(res => {
            this.tableData = res.data;
          });

        getSharePerformanceReportErrorsTop5(this.shareId, this.id)
          .then(res => {
            this.handleGetTop5(res.data);
          });
      } else {
        getPerformanceReportErrorsContent(this.id)
          .then(res => {
            this.tableData = res.data;
          });

        getPerformanceReportErrorsTop5(this.id)
          .then(res => {
            this.handleGetTop5(res.data);
          });
      }
