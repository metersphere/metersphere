...
public class DocumentElement {
    ...
    public DocumentElement(String name, String type, Object expectedOutcome, List<DocumentElement> children) {
        ...
        if (StringUtils.equalsAny(type, PropertyConstant.OBJECT, PropertyConstant.ARRAY)) {
            this.contentVerification = PropertyConstant.NONE;
    ...
    public DocumentElement newRoot(String type, List<DocumentElement> children) {
        return new DocumentElement(PropertyConstant.ROOT, PropertyConstant.ROOT, type, "", children);
    }
