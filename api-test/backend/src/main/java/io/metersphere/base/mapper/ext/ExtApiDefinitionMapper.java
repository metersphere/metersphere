...
public interface ExtApiDefinitionMapper {
    ...
    List<ApiDefinitionWithBLOBs> selectRepeatByProtocol(@Param("blobs") List<ApiDefinitionWithBLOBs> blobs, @Param("protocol") String protocol, @Param("projectId") String projectId);
