<template xmlns:v-slot="http://www.w3.org/1999/XSL/Transform">
  ...
  <div style="border: 1px #dcdfe6 solid" v-if="!loading">
    <el-tabs v-model="activeName" class="request-tabs">
      <!-- 请求头-->
      <el-tab-pane
        :label="$t('api_test.request.headers')"
        name="headers"
        v-if="request.header"
      >
      ...
      >
        <el-radio-group v-model="activeBody" size="mini">
          ...
          <el-radio-button
            label="raw"
            v-if="request.body.raw_1 || request.body.raw_2"
          />
        ...
        <ms-json-code-edit
          :body="request.body"
          ref="jsonCodeEdit"
          v-if="activeBody === 'json'"
        />
        <pre
          v-html="getDiff(request.body.raw_2, request.body.raw_1)"
          v-if="activeBody === 'raw'"
        ></pre>
        <ms-api-key-value-detail
          :show-required="true"
