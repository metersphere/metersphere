    ...
    <div class="ms-header">
      <el-row>
        ...
        <el-col :span="12">
          ...
          <el-dropdown split-button type="primary" @click="debugScenario" style="margin:0px 10px 0px" size="mini"
                       @command="handleCommand" v-show="!debugLoading">
      ...
      <ms-aside-container @setAsideHidden="setAsideHidden" style="padding: 0px;overflow: hidden">
        ...
        <div v-loading="loading" v-if="!asideHidden">
          <el-tree node-key="resourceId"
                   ...
                   :allow-drop="allowDrop" @node-drag-end="allowDrag" @node-click="nodeClick" class="ms-max-tree"
                   ref="maxStepTree">
            <el-row class="custom-tree-node" :gutter="18" type="flex" align="middle" slot-scope="{node, data}"
                    style="width: 98%">
              <el-col class="custom-tree-node-col" style="padding-left:0px;padding-right:0px"
              ...
              <!-- 批量操作 -->
              <el-col :class="data.checkBox? 'custom-tree-node-hide' : 'custom-tree-node-col'"
                ...
                <show-more-btn :is-show="node.checked" :buttons="batchOperators" :size="selectDataCounts"
                               v-show="data.checkBox" style="margin-right: 3px"/>
              </el-col>
              <el-col>
                <!-- 步骤组件-->
                <ms-component-config
