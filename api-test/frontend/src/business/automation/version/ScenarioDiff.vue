  ...
  <div v-show="showDiff">
    <el-row>
      <el-col :span="12">
        ...
        <span style="margin-left: 10px">{{ oldUserName }}</span><span
        style="margin-left: 10px">{{ oldCreateTime | datetimeFormat }}</span>
      </el-col>
      <el-col :span="12">
        <el-tag>{{ newData.versionName }}</el-tag>
        <span style="margin-left: 10px">{{ newData.userName }}</span><span
        style="margin-left: 10px">{{ newCreateTime | datetimeFormat }}</span>
      </el-col>
    </el-row>
                ...
                <el-row>
                  ...
                  <el-col :span="7">
                    <el-form-item :label="$t('test_track.module.module')" prop="apiScenarioModuleId">
                      <ms-select-tree size="small" :data="moduleOptions" :defaultKey="oldData.apiScenarioModuleId"
                ...
                <el-col :span="21">
                  ...
                  <div class="ms-debug-div" @click="showAll" :class="{'is-top' : isTop}" ref="debugHeader">
                    <el-row style="margin: 5px">
                      ...
                      <el-col :span="3" class="ms-col-one ms-font">
                        <el-checkbox v-model="oldEnableCookieShare"><span
                          style="font-size: 13px;">{{ $t('api_test.scenario.share_cookie') }}</span></el-checkbox>
                      </el-col>
                      <el-col :span="3" class="ms-col-one ms-font">
                        <el-checkbox v-model="oldOnSampleError"><span
                          style="font-size: 13px;">{{ $t('commons.failure_continues') }}</span></el-checkbox>
                      </el-col>
                  ...
                  <div ref="stepInfo" id="stepInfo">
                    <el-tooltip :content="$t('api_test.automation.open_expansion')" placement="top" effect="light">
                      <i class="el-icon-circle-plus-outline ms-open-btn ms-open-btn-left"
            ...
            <div class="ms-main-div" @click="showAll" v-if="type!=='detail'">
              ...
              <el-form :model="newData" label-position="right" label-width="80px" size="small" :rules="rules"
                ...
                <el-row>
                  ...
                  <el-col :span="7">
                    <el-form-item :label="$t('test_track.module.module')" prop="apiScenarioModuleId">
                      <ms-select-tree size="small" :data="moduleOptions" :defaultKey="newData.apiScenarioModuleId"
                                      :obj="moduleObj" clearable checkStrictly/>
                    </el-form-item>
                  </el-col>
                  <el-col :span="7">
                ...
                <el-col :span="21">
                  ...
                  <div class="ms-debug-div" @click="showAll" :class="{'is-top' : isTop}" ref="debugHeader">
                    <el-row style="margin: 5px">
                      ...
                      <el-col :span="3" class="ms-col-one ms-font">
                        <el-checkbox v-model="newEnableCookieShare"><span
                          style="font-size: 13px;">{{ $t('api_test.scenario.share_cookie') }}</span></el-checkbox>
                      </el-col>
                      <el-col :span="3" class="ms-col-one ms-font">
                        <el-checkbox v-model="newOnSampleError"><span
                          style="font-size: 13px;">{{ $t('commons.failure_continues') }}</span></el-checkbox>
                      </el-col>
