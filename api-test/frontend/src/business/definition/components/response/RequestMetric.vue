<template>
  <div class="metric-container">
    <el-row type="flex">
      <el-col>
        ...
        >
          ...
          >
            {{
              responseResult && responseResult.responseCode
          ...
          <div
            ...
            class="node-title"
            :class="
              response && response.success ? 'ms-req-success' : 'ms-req-error'
            "
          >
            {{
              responseResult && responseResult.responseCode
      ...
      <el-col>
        ...
        >
          {{
            responseResult && responseResult.responseTime
      ...
      <el-col>
        ...
        >
          {{
            responseResult && responseResult.responseSize
              ? responseResult.responseSize
              : 0
          }}
          bytes
        </div>
    ...
    <el-row type="flex" v-if="response && response.envName">
      ...
      <div
        style="font-size: 14px; color: #61c550; margin-left: 10px; float: left"
      >
        {{ response.envName }}
      </div>
    </el-row>
