  ...
  <el-card class="card-content" v-if="isShow">
    <el-button-group v-if="isShowChangeButton">
      <el-tooltip
        class="item"
        effect="dark"
        :content="$t('api_test.definition.api_title')"
        placement="left"
      >
        <el-button
          plain
          style="width: 44px; height: 32px; padding: 5px 8px"
          :class="{ active: showApiList }"
          @click="changeTab('api')"
          >API</el-button
        >
      </el-tooltip>
      ...
      <el-tooltip
        class="item"
        effect="dark"
        :content="$t('api_test.definition.case_title')"
        placement="top"
      >
        <el-button
          plain
          style="width: 44px; height: 32px; padding: 1px"
          :class="{ active: showTestCaseList }"
          @click="changeTab('testCase')"
          >CASE</el-button
        >
      </el-tooltip>
      ...
      <el-tooltip
        class="item"
        effect="dark"
        :content="$t('api_test.definition.doc_title')"
        placement="right"
      >
        <el-button
          plain
          style="width: 44px; height: 32px; padding: 1px"
          :class="{ active: showDocList }"
          @click="changeTab('doc')"
        >
