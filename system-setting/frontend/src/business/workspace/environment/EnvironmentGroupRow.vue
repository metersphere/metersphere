...
import {getEnvGroupProject, getEnvironments, updateEnvironmentGroup} from "../../../api/environment";
  ...
  methods: {
    projectChange(item) {
      if (item && item.projectId) {
        ...
        getEnvironments(item.projectId).then(res => {
    ...
    getEnvironmentGroupProject() {
      ...
      this.loading = getEnvGroupProject(this.envGroupId).then(res => {
        this.envGroupProject = res.data;
    ...
    update() {
      ...
      this.loading = updateEnvironmentGroup(param).then(() => {
