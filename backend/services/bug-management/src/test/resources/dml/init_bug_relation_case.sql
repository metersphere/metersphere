INSERT INTO bug (id, num, title, handle_users, handle_user, create_user, create_time,
    ...
    ('bug_id_1', 100000, 'default-bug', 'oasis', 'oasis', 'admin', UNIX_TIMESTAMP() * 1000, 'admin', UNIX_TIMESTAMP() * 1000, 'admin', UNIX_TIMESTAMP() * 1000, 'project_wx_associate_test', 'bug-template-id', 'Local', 'open', '["default-tag"]', null, 0, 5000),
    ('bug_id_2', 100001, 'default-bug', 'oasis', 'oasis', 'admin', UNIX_TIMESTAMP() * 1000, 'admin', UNIX_TIMESTAMP() * 1000, 'admin', UNIX_TIMESTAMP() * 1000, 'project_wx_associate_test', 'bug-template-id', 'Local', 'open', '["default-tag"]', null, 0, 10000);
