...
public class FunctionalCaseImportEventListener extends AnalysisEventListener<Map<Integer, String>> {
    ...
    public FunctionalCaseImportEventListener(FunctionalCaseImportRequest request, Class clazz, List<TemplateCustomFieldDTO> customFields, Set<ExcelMergeInfo> mergeInfoSet) {
