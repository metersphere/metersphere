...
INSERT INTO case_review_functional_case(id, review_id, case_id, create_time, create_user, update_time)
VALUES ('associate_id1', 'case_review_associate_Id', 'associate_case_gyq_id', 1698058347559,'admin',1698058347559),
       ('associate_id2', 'case_review_associate_Id2', 'associate_case_gyq_id', 1698058347559,'admin',1698058347559);
