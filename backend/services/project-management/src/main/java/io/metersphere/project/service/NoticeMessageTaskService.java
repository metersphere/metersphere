...
public class NoticeMessageTaskService {
    ...
    public void updateMessage(MessageTaskRequest messageTaskRequest, String userId) {
        return;
    }

    public List<MessageTask> getMessageData(String projectId) {
        MessageTaskExample messageTaskExample = new MessageTaskExample();
        messageTaskExample.createCriteria().andProjectIdEqualTo(projectId);
        return messageTaskMapper.selectByExample(messageTaskExample);
    }
}
