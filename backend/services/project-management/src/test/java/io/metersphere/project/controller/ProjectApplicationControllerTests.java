...
public class ProjectApplicationControllerTests extends BaseTest {
    ...
    void coverPlatformTest() {
        ...
        projectApplicationService.getPlatform("default-project-for-application", true);
        // 获取同步机制
        projectApplicationService.isPlatformSyncMethodByIncrement("default-project-for-application");
        projectApplicationService.isPlatformSyncMethodByIncrement("default-project-for-application-not-exist");
