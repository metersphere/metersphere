...
VALUES ('message_task_id1', 'CASE_EXECUTE_FAKE_ERROR', 'FOLLOW_PEOPLE', '测试机器人1', 'API_DEFINITION_TASK', 'NONE',  'test', true, 'admin', unix_timestamp() * 1000,'admin',  unix_timestamp() * 1000, true, true, 'message.title.api_definition_task_case_delete');
