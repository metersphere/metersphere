...
public class OrganizationController {
    ...
    @Operation(summary = "系统-组织-成员-获取组织成员列表")
    ...
    @Operation(summary = "系统-组织-成员-添加组织成员")
    ...
    @Operation(summary = "系统-组织-成员-添加组织成员至用户组")
    ...
    @Operation(summary = "系统-组织-成员-更新用户")
    ...
    @Operation(summary = "系统-组织-成员-添加组织成员至项目")
    ...
    @Operation(summary = "系统-组织-成员-删除组织成员")
    @Parameters({
    ...
    @Operation(summary = "系统-组织-成员-获取当前组织下的所有项目")
    ...
    @Operation(summary = "系统-组织-成员-获取当前组织下的所有自定义用户组以及组织级别的用户组")
    @RequiresPermissions(PermissionConstants.ORGANIZATION_MEMBER_READ)
    ...
    @Operation(summary = "系统-组织-成员-获取不在当前组织的所有用户")
