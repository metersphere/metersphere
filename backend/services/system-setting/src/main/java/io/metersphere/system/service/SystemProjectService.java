...
public class SystemProjectService {
     ...
     * @return
     */
    public Project add(AddProjectDTO addProjectDTO , String createUser) {
    ...
    public Project update(UpdateProjectDTO updateProjectDto, String updateUser) {
        Project project = new Project();
        ...
        request.getUserIds().forEach(userId -> {
            ...
            if (isAdmin) {
                UserRoleRelation adminRole = new UserRoleRelation(
                        ...
                        userId,
                        UserRoleConstants.PROJECT_ADMIN,
