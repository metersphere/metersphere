package io.metersphere.system.ai.holder;

import io.metersphere.system.ai.engine.AIChatClient;
import io.metersphere.system.ai.engine.AIModelType;
import io.metersphere.system.ai.engine.AIRegister;
...
public class ChatClientHolder {
     ...
     * 并使用 {@link AIRegister} 注解中的模型类型值将它们注册到 {@link MODEL_MAP} 中。
     *
     ...
     */
    public static ChatClient getChatClient(String modelType, ModelConfigDTO options) {
