...
public class SystemProjectController {
    ...
    @PostMapping("/add")
    @RequiresPermissions(PermissionConstants.ORGANIZATION_PROJECT_MANAGER_READ_ADD)
    ...
    @GetMapping("/get/{id}")
    @RequiresPermissions(PermissionConstants.ORGANIZATION_PROJECT_MANAGER_READ)
    ...
    @PostMapping("/update")
    @RequiresPermissions(PermissionConstants.ORGANIZATION_PROJECT_MANAGER_READ_UPDATE)
    ...
    @PostMapping("/delete")
    @RequiresPermissions(PermissionConstants.ORGANIZATION_PROJECT_MANAGER_READ_DELETE)
    ...
    @RequiresPermissions(PermissionConstants.ORGANIZATION_PROJECT_MANAGER_READ_ADD_USER)
   ...
   /* @PostMapping("/addMember/{projectId}")
    ...
    @RequiresPermissions(PermissionConstants.ORGANIZATION_PROJECT_MANAGER_READ_DELETE_USER)
