...
public class SystemProjectController {
    ...
    public Project addProject(@RequestBody @Validated({Created.class}) AddProjectDTO project) {
    ...
    public Project updateProject(@RequestBody @Validated({Updated.class}) UpdateProjectDTO project) {
