...
public class TestResourcePoolController {
    ...
    @PostMapping("/add")
    @Operation(summary = "系统-资源池-添加资源池")
    ...
    @CacheNode // 把监控节点缓存起来
    @Operation(summary = "系统-资源池-删除资源池")
    ...
    @PostMapping("/update")
    @CacheNode // 把监控节点缓存起来
    @Operation(summary = "系统-资源池-更新资源池")
    ...
    @PostMapping("/page")
    @Operation(summary = "系统-资源池-获取资源池列表")
    ...
    @Operation(summary = "系统-资源池-资源池禁用")
    @RequiresPermissions(PermissionConstants.SYSTEM_TEST_RESOURCE_POOL_READ_UPDATE)
