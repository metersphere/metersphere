...
import io.metersphere.system.ai.holder.ChatClientHolder;
import io.metersphere.system.ai.tools.ToolsService;
...
public class ChatToolEngine {
     ...
     * @param modelConfig   聊天选项
     * @return Builder 实例
     */
    public static Builder builder(String modelType, ModelConfigDTO modelConfig) {
        return new Builder(modelType, modelConfig);
    }
    ...
    public static class Builder {
         ...
         * @param modelConfig   聊天选项
         */
        private Builder(String modelType, ModelConfigDTO modelConfig) {
            this.chatClient = ChatClientHolder.getChatClient(modelType, modelConfig);
        }
        ...
        /**
         * 设置日志顾问，自动记录经过该顾问的聊天请求和响应
         *
         * @param order 可以通过设置 order 值来控制执行顺序。值较低的将首先执行。
         * @return  SimpleLoggerAdvisor 实例，用于日志记录
         */
        public SimpleLoggerAdvisor orderLoggerAdvisor(int order) {
            return new SimpleLoggerAdvisor(order);
        }

        /**
         * 聊天记忆顾问
         * 检索记忆并将其作为消息集合添加到提示中。
         * 此方法可维护对话历史记录的结构。请注意，并非所有 AI 模型都支持此方法。
         * @return MessageChatM emoryAdvisor
         */
        public MessageChatMemoryAdvisor messageChatMemoryAdvisor() {
            return new MessageChatMemoryAdvisor(this.chatMemory);
        }
        ...
        /**
         * 构建带有顾问与工具的Client
         * @param toolsService 工具服务
         * @param chatModel 聊天模型
         * @return ChatClient
         */
        private ChatClient getChatClient(ToolsService toolsService, ChatModel chatModel) {
            return ChatClient.builder(chatModel)
                    .defaultAdvisors(orderLoggerAdvisor(100),
