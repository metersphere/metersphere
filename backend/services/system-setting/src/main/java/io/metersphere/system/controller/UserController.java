...
public class UserController {
    ...
    @PostMapping("/add")
    @Operation(summary = "系统设置-用户-添加用户")
    ...
    @PostMapping("/update")
    @Operation(summary = "系统设置-用户-修改用户")
    ...
    @Operation(summary = "系统设置-用户-启用/禁用用户")
    @RequiresPermissions(PermissionConstants.SYSTEM_USER_READ_UPDATE)
    ...
    @Operation(summary = "系统设置-用户-导入用户")
    ...
    @PostMapping("/delete")
    @Operation(summary = "系统设置-用户-删除用户")
    ...
    @Operation(summary = "系统设置-用户-重置用户密码")
    @RequiresPermissions(PermissionConstants.SYSTEM_USER_READ_UPDATE)
    ...
    @Operation(summary = "系统设置-用户-查找系统级用户组")
    ...
    @Operation(summary = "系统设置-用户-用户批量操作-查找组织")
    ...
    @Operation(summary = "系统设置-用户-用户批量操作-查找项目")
    @RequiresPermissions(value = {PermissionConstants.SYSTEM_USER_ROLE_READ, PermissionConstants.SYSTEM_ORGANIZATION_PROJECT_READ}, logical = Logical.AND)
    ...
    @Operation(summary = "系统设置-用户-批量添加用户到多个用户组中")
    @RequiresPermissions(PermissionConstants.SYSTEM_USER_READ_UPDATE)
    ...
    @Operation(summary = "系统设置-用户-批量添加用户到项目")
    ...
    @Operation(summary = "系统设置-用户-批量添加用户到组织")
    @RequiresPermissions(value = {PermissionConstants.SYSTEM_USER_READ_UPDATE, PermissionConstants.SYSTEM_ORGANIZATION_PROJECT_MEMBER_ADD}, logical = Logical.AND)
