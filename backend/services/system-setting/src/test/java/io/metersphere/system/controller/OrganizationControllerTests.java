...
public class OrganizationControllerTests extends BaseTest {
    ...
    public void addMemberByOrgTestsSuccess() throws Exception {
    ...
    public void testUpdateOrganizationMemberSuccess() throws Exception {
        ...
        organizationMemberRequest.setOrganizationId("sys_default_organization_3");
        organizationMemberRequest.setMemberIds(Arrays.asList("sys_default_user", "sys_default_user2"));
        organizationMemberRequest.setUserRoleIds(List.of("sys_default_org_role_id_1"));
        this.requestPost(ORGANIZATION_UPDATE_MEMBER, organizationMemberRequest, status().isOk());
        // 批量添加成员成功后, 验证是否添加成功
        listByKeyWord("testUserTwo","sys_default_organization_3");
    }
    ...
    public void testOrganizationMemberListSuccess() throws Exception {
        listByKeyWord("testUserOne","sys_default_organization_3");
    }
    ...
    private void listByKeyWord(String keyWord,String orgId) throws Exception {
        OrganizationRequest organizationRequest = new OrganizationRequest();
        organizationRequest.setCurrent(1);
        organizationRequest.setPageSize(10);
