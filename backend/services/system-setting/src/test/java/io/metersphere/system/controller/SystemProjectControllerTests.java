...
import io.metersphere.sdk.dto.AddProjectDTO;
import io.metersphere.sdk.dto.ProjectDTO;
import io.metersphere.sdk.dto.UpdateProjectDTO;
...
public class SystemProjectControllerTests extends BaseTest {
    ...
    public AddProjectDTO generatorAdd(String organizationId, String name, String description, boolean enable, List<String> userIds) {
        ...
        addProjectDTO.setEnable(false);
        addProjectDTO.setUserIds(userIds);
        return addProjectDTO;
    }
    public UpdateProjectDTO generatorUpdate(String organizationId,String projectId, String name, String description, boolean enable) {
        ...
        updateProjectDTO.setEnable(false);
    ...
    public void testAddProjectSuccess() throws Exception {
        AddProjectDTO project = this.generatorAdd("organizationId","name", "description", true, List.of("admin"));
    ...
    public void testUpdateProject() throws Exception {
        UpdateProjectDTO project = this.generatorUpdate("organizationId", "projectId","TestName", "Edit name", true);
    ...
    public void testUpdateProjectError() throws Exception {
        //项目名称存在 500
        UpdateProjectDTO project = this.generatorUpdate("organizationId", "projectId","TestName", "description", true);
        ...
        //项目Id为空
        project = this.generatorUpdate("organizationId", null,null, null, true);
        this.requestPost(updateProject, project, BAD_REQUEST_MATCHER);
        //项目名称为空
        project = this.generatorUpdate("organizationId", "projectId",null, null, true);
        this.requestPost(updateProject, project, BAD_REQUEST_MATCHER);
        //项目不存在
        project = this.generatorUpdate("organizationId", "1111","123", null, true);
        MvcResult mvcResult = this.responsePost(updateProject, project);
        String returnData = mvcResult.getResponse().getContentAsString(StandardCharsets.UTF_8);
        ResultHolder resultHolder = JsonUtils.parseObject(returnData, ResultHolder.class);
        Assertions.assertNull(resultHolder.getData());
    ...
    public void testAddProjectMember() throws Exception{
        ...
        Assertions.assertEquals(userRoleRelations.size(), 2);
