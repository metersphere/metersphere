...
public class KubernetesEngineTests extends BaseTest {
    ...
    private String addPool(String name, Boolean allOrg, Boolean partOrg, Boolean useApi, Boolean useLoad, Boolean useUi, String type) throws Exception {
    ...
    public void pluginSubTypeTest() throws Exception {
        String id = this.addPool("api_test_pool", true, false, false, false, false, ResourcePoolTypeEnum.NODE.name());
