...
public class ApiDefinitionPreImportAnalysisResult {
    ...
    List<ApiDefinitionImportDetail> insertApiData = new ArrayList<>();

    @Schema(description = "需要更新的接口")
    List<ApiDefinitionImportDetail> updateApiData = new ArrayList<>();
    @Schema(description = "只需要更所属模块的接口")
    List<ApiDefinitionImportDetail> updateModuleApiList = new ArrayList<>();
    ...
    Map<String, ApiDefinitionImportDetail> logData = new HashMap<>();
}
