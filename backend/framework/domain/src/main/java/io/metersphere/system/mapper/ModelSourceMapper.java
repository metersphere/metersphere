...
public interface ModelSourceMapper {
    ...
    List<ModelSource> selectByExampleWithBLOBs(ModelSourceExample example);
    ...
    int updateByExampleWithBLOBs(@Param("record") ModelSource record, @Param("example") ModelSourceExample example);
    ...
    int updateByPrimaryKeyWithBLOBs(ModelSource record);
