...
public class ApiReportLog implements Serializable {
    ...
    @NotBlank(message = "{api_report_log.id.not_blank}", groups = {Updated.class})
    @Size(min = 1, max = 50, message = "{api_report_log.id.length_range}", groups = {Created.class, Updated.class})
    private String id;
