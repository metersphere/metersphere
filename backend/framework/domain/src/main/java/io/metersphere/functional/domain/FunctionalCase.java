...
public class FunctionalCase implements Serializable {
    ...
    @Size(min = 1, max = 19, message = "{functional_case.num.length_range}", groups = {Created.class, Updated.class})
    private Long num;
    ...
    @Schema(title = "评审结果：未评审/评审中/通过/不通过/重新提审", requiredMode = Schema.RequiredMode.REQUIRED)
