...
public class UiCustomCommandBlob implements Serializable {
    ...
    public enum Column {
        ...
        scenarioDefinition("scenario_definition", "scenarioDefinition", "LONGVARBINARY", false),
        commandViewStruct("command_view_struct", "commandViewStruct", "LONGVARBINARY", false);
