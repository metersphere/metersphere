...
public class HashTreeUtil {
    ...
    public Map<String, Map<String, String>> mergeParamDataMap(Map<String, Map<String, String>> execute_env_param_datas, Map<String, Map<String, String>> envParamsMap) {
        if(execute_env_param_datas == null){
            execute_env_param_datas = new HashMap<>();
        }
        if(envParamsMap == null){
            return  execute_env_param_datas;
        }
        for (Map.Entry<String,Map<String,String>> paramEnvMapEntry:envParamsMap.entrySet()) {
            ...
            if(execute_env_param_datas.containsKey(envId)){
                execute_env_param_datas.get(envId).putAll(map);
            }else {
                execute_env_param_datas.put(envId,map);
            }
        }
        return execute_env_param_datas;
    }
