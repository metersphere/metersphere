...
//            request.getConfig().getReportType()
    ...
    public String run(String testPlanID, String projectID, String userId, String triggerMode, String apiRunConfig) {
        ...
        //执行接口案例任务
        this.executeApiTestCase(triggerMode, planReportId, testPlanID,new ArrayList<>(apiTestCaseDataMap.values()), runModeConfig);
        //执行场景执行任务
    ...
    private void executeApiTestCase(String triggerMode, String planReportId, String testPlanId, List<String> planCaseIds, RunModeConfig runModeConfig) {
        executorService.submit(() -> {
