...
public class IssuesService {
    ...
    public List<IssuesDao> list(IssuesRequest request) {
       ...
       /* TapdPlatform tapdPlatform = (TapdPlatform) IssueFactory.createPlatform(IssuesManagePlatform.Tapd.name(), request);
        ZentaoPlatform zentaoPlatform = (ZentaoPlatform) IssueFactory.createPlatform(IssuesManagePlatform.Zentao.name(), request);*/
        ...
        issues.forEach(item -> {
            ...
            /*setPlatformInfo(tapdPlatform, zentaoPlatform, item);*/
        });
        return issues;
    }

    private void setPlatformInfo(TapdPlatform tapdPlatform, ZentaoPlatform zentaoPlatform, IssuesDao item) {
        try {
