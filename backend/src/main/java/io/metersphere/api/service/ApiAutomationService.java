...
public class ApiAutomationService {
    ...
    public void delete(String id) {
        ...
        apiScenarios.forEach(s -> {
            deleteRelationByScenarioId(s.getId(),s.getScenarioDefinition());
        });
    }

    private void deleteRelationByScenarioId(String scenarioId,String scenarioDefinition) {
        //及连删除外键表
        this.preDelete(scenarioId,scenarioDefinition);
        testPlanScenarioCaseService.deleteByScenarioId(scenarioId);
        apiScenarioMapper.deleteByPrimaryKey(scenarioId);
