...
public class ApiAutomationController {
    ...
    @RequiresPermissions(value = {PermissionConstants.PROJECT_API_SCENARIO_READ_EDIT, PermissionConstants.PROJECT_API_SCENARIO_READ_MOVE_BATCH}, logical = Logical.OR)
