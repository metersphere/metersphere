...
INSERT INTO custom_field (id, name, scene, `type`, remark, `options`, `system`, `global`, workspace_id, create_time,
                          update_time)
VALUES ('09642424-7b1b-4004-867e-ff9c798a1933', 'custom_field.issue_creator', 'ISSUE', 'member', '', '[]', 1, 1,
        'global', unix_timestamp() * 1000, unix_timestamp() * 1000);
INSERT INTO custom_field (id, name, scene, `type`, remark, `options`, `system`, `global`, workspace_id, create_time,
                          update_time)
VALUES ('a577bc60-75fe-47ec-8aa6-32dca23bf3d6', 'custom_field.issue_processor', 'ISSUE', 'member', '', '[]', 1, 1,
        'global', unix_timestamp() * 1000, unix_timestamp() * 1000);
INSERT INTO custom_field (id, name, scene, `type`, remark, `options`, `system`, `global`, workspace_id, create_time,
                          update_time)
VALUES ('beb57501-19c8-4ca3-8dfb-2cef7c0ea087', 'custom_field.issue_status', 'ISSUE', 'select', '',
...
INSERT INTO custom_field (id, name, scene, `type`, remark, `options`, `system`, `global`, workspace_id, create_time,
                          update_time)
VALUES ('d392af07-fdfe-4475-a459-87d59f0b1626', 'custom_field.issue_severity', 'ISSUE', 'select', '',
...
-- 系统模板
INSERT INTO test_case_template (id, name, `type`, description, case_name, prerequisite, step_description,
                                expected_result, actual_result, `system`, `global`, workspace_id, create_time,
                                update_time)
VALUES ('b395d8fe-2ad6-4de7-81d3-2006b53a97c8', 'default', 'functional', 'Test case default template.', '', '', '', '',
        '', 1, 1, 'global', unix_timestamp() * 1000, unix_timestamp() * 1000);
...
-- 系统模板
INSERT INTO issue_template (id, `name`, platform, description, title, `global`, `system`, workspace_id, content,
                            create_time, update_time)
VALUES ('5d7c87d2-f405-4ec1-9a3d-71b514cdfda3', 'default', 'metersphere', '', '', 1, 1, 'global', '',
...
VALUES ('0d2b90ec-9c56-4f5d-ae06-522a93f48e93', '46065143-9d1d-11eb-b418-0242ac120002',
        'b395d8fe-2ad6-4de7-81d3-2006b53a97c8', 'TEST_CASE', 1, '');
INSERT INTO custom_field_template (id, field_id, template_id, scene, required, default_value)
VALUES ('661e1e29-c401-43b0-972e-a713b7b90c37', '4619cc23-9d1d-11eb-b418-0242ac120002',
        'b395d8fe-2ad6-4de7-81d3-2006b53a97c8', 'TEST_CASE', 1, '"PO"');
INSERT INTO custom_field_template (id, field_id, template_id, scene, required, default_value)
VALUES ('f448e8d2-fad1-4c23-a013-3f3ba282bb81', '45f2de57-9d1d-11eb-b418-0242ac120002',
        'b395d8fe-2ad6-4de7-81d3-2006b53a97c8', 'TEST_CASE', 1, '"Prepare"');

-- 系统缺陷模板关联系统字段
INSERT INTO custom_field_template (id, field_id, template_id, scene, required, default_value)
VALUES ('3d6a182f-cea7-452e-828d-4550edada409', 'd392af07-fdfe-4475-a459-87d59f0b1626',
        '5d7c87d2-f405-4ec1-9a3d-71b514cdfda3', 'ISSUE', 1, '"P0"');
INSERT INTO custom_field_template (id, field_id, template_id, scene, required, default_value)
VALUES ('657e70c3-0d1b-4bbe-b52f-bfadee05148a', '09642424-7b1b-4004-867e-ff9c798a1933',
        '5d7c87d2-f405-4ec1-9a3d-71b514cdfda3', 'ISSUE', 1, '');
INSERT INTO custom_field_template (id, field_id, template_id, scene, required, default_value)
VALUES ('b8921cbc-05b3-4d8f-a96e-d1e4ae9d8664', 'a577bc60-75fe-47ec-8aa6-32dca23bf3d6',
        '5d7c87d2-f405-4ec1-9a3d-71b514cdfda3', 'ISSUE', 1, '');
INSERT INTO custom_field_template (id, field_id, template_id, scene, required, default_value)
VALUES ('d5908553-1b29-4868-9001-e938822b92ef', 'beb57501-19c8-4ca3-8dfb-2cef7c0ea087',
        '5d7c87d2-f405-4ec1-9a3d-71b514cdfda3', 'ISSUE', 1, '"NEW"');
