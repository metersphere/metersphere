...
ALTER TABLE test_case_issues
    ADD ref_type varchar(30) DEFAULT 'FUNCTIONAL' NOT NULL;
ALTER TABLE test_case_issues
    CHANGE test_case_id resource_id varchar(50) NOT NULL;
ALTER TABLE test_case_issues
    ADD ref_id varchar(50) NULL COMMENT '测试计划的用例所指向的用例的id';
