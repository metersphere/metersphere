<template>
  <div>
    ...
    <el-dialog :visible="visible" append-to-body :title="$t('workspace.env_group.name')" @close="visible = false" style="height: 800px;">
      <template>
...
import {environmentGetALl} from "@/api/environment";
import {getEnvironmentMapByGroupId} from "metersphere-frontend/src/api/environment";
